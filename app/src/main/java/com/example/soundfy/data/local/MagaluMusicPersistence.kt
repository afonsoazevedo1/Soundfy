package com.example.soundfy.data.local
...
class SoundfyPersistence @Inject constructor(
    ...
    private val prefs = context.getSharedPreferences("soundfy_prefs", Context.MODE_PRIVATE)
